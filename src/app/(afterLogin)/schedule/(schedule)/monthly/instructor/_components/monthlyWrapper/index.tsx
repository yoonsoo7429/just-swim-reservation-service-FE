...
import {
  getMonthlyScheduleInfoForInstructor,
  getToday,
  getWeekNumber,
  numberFormat,
  randomId,
} from "@utils";
import { CalendarItemProps, ScheduleSummaryForInstructor } from "@types";
...
export function MonthlyWrapper() {
  ...
  useEffect(() => {
    const getMonthInfo = async () => {
      const result = await getMonthlyScheduleInfoForInstructor(
